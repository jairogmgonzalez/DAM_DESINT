...
public class VentanaError extends javax.swing.JDialog {
   ...
   // Constructor por defecto de la clase Error
    public VentanaError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    // Se añade un Listener a jButtonVolver
    public void addVolverAction(ActionListener listener){
    ...
    private void initComponents() {
        ...
        jLabelError.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jLabelError.setText("Se produjo algún tipo de error");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaError dialog = new VentanaError(new javax.swing.JFrame(), true);
